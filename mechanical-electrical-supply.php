...
<body>
  ...
  <section class="w3l-about-breadcrumb text-center">
    <div class="breadcrumb-bg breadcrumb-bg-Companypy-sm-5 py-4" style="background: url(assets/images/mechanical.jpeg) no-repeat center;">
      <div class="container py-2"> <br><br>
        <h2 class="title">Mechanical & Electrical Supply </h2> <br><br>
