...
<body>
  ...
  <section class="w3l-about-breadcrumb text-center">
    <div class="breadcrumb-bg breadcrumb-bg-Companypy-sm-5 py-4" style="background: url(assets/images/offshore1.jpeg) no-repeat center;">
      <div class="container py-2"> <br><br>
        <h2 class="title">Equipment & Instrumentation</h2> <br><br>
        ...
        <div class="container py-md-5">
          <div class="row bottom-ab-grids align-items-center">
            <div class="col-lg-6 bottom-ab-left mt-lg-0 mt-5">
                <img src="assets/images/offshore.jpeg" class="img-fluid" alt="">
              </div>
            <div class="col-lg-6 bottom-ab-right pr-lg-5">
              <!-- <h6 class="sub-title">About Us</h6> -->
              <h3 class="hny-title">Equipment & Instrumentation</h3>
